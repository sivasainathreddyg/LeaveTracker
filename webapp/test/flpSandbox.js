		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Leave Tracker",
									"targetURL": "#comleavetrackerleavetracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comleavetrackerleavetracker-display": {
								"semanticObject": "comleavetrackerleavetracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.leavetracker.leavetracker",
									"url": sap.ui.require.toUrl("com/leavetracker/leavetracker")
								}
							}
						}
					}
